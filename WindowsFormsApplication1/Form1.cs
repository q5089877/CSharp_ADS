...
//    {
//        //MyCapture myCapture = new MyCapture();
//        log log = new log();
//        //Step2 ADS Client宣告
...
//            //    UpdateUI("連線成功！");
//            //    log.WriteLog(DateTime.Now.ToString("yyyyMMdd HH-mm-ss") + "連線成功" + currentRetry.ToString());
//            //}
//            //else
//            //{
//            //    // 失敗, 再重試
...
//            //    log.WriteLog(DateTime.Now.ToString("yyyyMMdd HH-mm-ss") + "連線失敗" + currentRetry.ToString());
//            //}
//        }
...
//                    {
//                        //同時判斷二個Camera
//                        if (myCapture.cameraTest(icImagingControl1) && myCapture.cameraTest(icImagingControl2))
//                        {
//                            bCameraReady = true;
//                        }
//                        else
